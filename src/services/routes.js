export const API_ROUTER = {
  ...
  ORDER_CLOSE: "paper_trade/orders/close/",
  ...
  STRATEGY_PREBUILD: (name) =>
    name
      ? `paper_trade/strategy/pre-build/?name=${name}`
      : "paper_trade/strategy/pre-build/",
  STRATEGY_UPDATE: (id) =>
    id ? `paper_trade/strategy/update/${id}/` : "paper_trade/strategy/update/", //wokrs with delete also
